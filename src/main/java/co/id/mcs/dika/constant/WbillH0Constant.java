...
public class WbillH0Constant {

    /**
     * Query export wbill H0 — data AGREE Credit Card dengan pickup_date =
     * CURRENT_DATE.
     ...
     * : master_segment_card (msc) — Credit_Card_Type_2
     * : customer_phone pivot — Phone1..Phone5
     * : oauth.agent (a)
     */
    public static final String WBILL_H0_QUERY = """
            WITH phone_pivot AS (
                SELECT
                    customer_id,
