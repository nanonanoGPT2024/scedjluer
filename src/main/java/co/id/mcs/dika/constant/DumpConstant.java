...
public class DumpConstant {
    ...
    public static final String DUMP_QUERY = """
            ...
            SELECT
                ...
                COALESCE(TO_CHAR(od.distribusi_date,     'YYYY-MM-DD'), '0000-00-00')           AS distribute_datespv,
                COALESCE(TO_CHAR(od.distribusi_date_spv, 'YYYY-MM-DD'), '0000-00-00')           AS distribute_datetsr,
                ...
                TO_CHAR(mc.begin_date, 'YYYY-MM-DD')                                            AS begin_date,
                TO_CHAR(mc.end_date,   'YYYY-MM-DD')                                            AS expire_date,
                ...
                COALESCE(TO_CHAR(od.tanggal_nilai, 'YYYY-MM-DD'), '-')                          AS tgl_approve_qa,
                COALESCE(od.prem_cred_line, '-')                                                AS tenor,
                '-'                                                                             AS volume,
                COALESCE(TO_CHAR(odd.pickup_date_remark, 'YYYY-MM-DD'), '-')                    AS pku_date,
